                        ...
                        <div class="m-widget19">
                            ...
                            <div class="m-widget19__content">
                                ...
                                <div class="mt-4 mb-4">
                                        ...
                                        <a href="{{route($route_name_prefix.'3d.models.update', ['id'=>$item->id])}}" class="btn m-btn--pill m-btn--air         btn-primary btn-sm">Sửa thông tin</a>
...
@elseif($type!="trash")
    <div class="col-12 my-5 py-5">
        <div class="btn-s text-center">
            <a href="{{route('admin.3d.models.upload')}}" class="btn btn-info">
