...
extract(get_result_blade_vars("Project", (isset($type) && strtolower($type) == 'trash')?'trash':'default'));
...
@if (count($results))
    <div class="list-project crazy-list">
        <div class="row">
                        ...
                        <div class="m-widget19">
                            ...
                            <div class="m-widget19__content">
                                ...
                                <div class="mt-4 mb-4">
                                        ...
                                        <a href="{{route($route_name_prefix.'3d.projects.update', ['id'=>$item->id])}}" class="btn m-btn--pill m-btn--air         btn-primary btn-sm">Sửa thông tin</a>
...
@elseif($type!="trash")
    <div class="col-12 my-5 py-5">
        <div class="btn-s text-center">
            <a href="{{route('admin.3d.projects.create')}}" class="btn btn-info">
