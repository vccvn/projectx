...
{{-- khai báo title --}}
@section('title', 'Project 3D')

{{-- tên modul xuất hiện trong sub header --}}
@section('module.name', 'Project 3D')
...
@section('content')
    ...
    <form method="POST" action="{{ route($route_name_prefix . '3d.projects.save') }}" id="crazy-info-form">
        @csrf
                        ...
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                ...
                                <h3 class="m-portlet__head-text">
                                    <span id="template-name-title">Upload Project</span>
                                </h3>
                            </div>
                        </div>
