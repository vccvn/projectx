                                                ...
                                                <div class="data" data="false" data-height="380" data-mobile-height="200">
                                                    <div class="m-nav-grid m-nav-grid--skin-light">
                                                        <div class="m-nav-grid__row">
                                                            <a href="{{route('admin.dynamics.list')}}" class="m-nav-grid__item">
                                                                <i class="m-nav-grid__icon flaticon-folder"></i>
                                                                <span class="m-nav-grid__text">Quản lý nôi dung</span>
                                                            </a>
                                                            <a href="{{route('admin.settings.group.form', ['group'=> 'siteinfo'])}}" class="m-nav-grid__item">
                                                        ...
                                                        <div class="m-nav-grid__row">
                                                            <a href="{{route('admin.themes.my-themes')}}" class="m-nav-grid__item">
