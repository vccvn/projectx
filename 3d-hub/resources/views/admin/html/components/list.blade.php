                ...
                <div class="m-portlet__body">
                    <div class="m-section mb-0">
                        <div class="m-section__content">';
                            $html.='
                            <div class="dd nestable component-list-body" id="component-area-'.$area->id.'" data-area-id="'.$area->id.'" data-max-depth="1" data-callback="App.components.sortCallback">
                                <ol class="dd-list">
                                    ';
...
<div class="tab-content html-areas">
    ...
    <div class="tab-pane" id="default_tab_content" role="tabpanel">
        {!! $render($areas['default'], 'layout', $layout, $render, $renderArea) !!}        
    </div>
