...
$col_class = 'col-12 col-sm-7 col-md-8 col-lg-9';
$lbl_class = 'col-12 col-sm-5 col-md-4 col-lg-3';
    ...
    <div class="{{$col_class}}">
        ...
        <div class="{{$input_group_class}}" id="attr-input-{!! $input->id !!}-group">
                    ...
                    <div id="product-variant-value-{{$value}}" class="variant-attribute-item">
                        ...
                        <div class="variant-option {{$checked?'show':''}}">
                            ...
                            <div class="crazy-form-group row {{$priceError?'has-danger':''}}">
                                <label for="variant-price-{{$attr_id}}-{{$value}}" class="col-12 col-sm-5 col-md-4 col-form-label">
                            ...
                            ?>
                                <div class="crazy-form-group row mt-2 {{$clrError?'has-danger':''}}">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-3 col-lg-4">
                                        @include('admin.forms.templates.colorpicker', [
                                            'input' => html_input([
                                                'type' => 'text',
            ...
            @else
                ...
                @if($is_template)
                    @include('admin.forms.templates.attribute-'.$input->template, ['input' => $input])
