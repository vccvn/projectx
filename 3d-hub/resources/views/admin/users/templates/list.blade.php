...
$web_types = get_system_config('web_typr_list');
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="tr_user" id="crazy-item-{{$user->id}}" data-name="{{$user->name}}">
                                ...
                                <td>
                                    <a href="{{$edit = route($route_name_prefix.'users.update', ['id'=>$user->id])}}">
                                        <img src="{{$user->getAvatar()}}" alt="{{$user->name}}" class="image-thumbnail">
                                    </a>
                                </td>
                                <td><a style="font-weight:500" href="{{$edit}}">{{$user->name}}</a></td>
                                <td>{{ $user->email }}</td>
