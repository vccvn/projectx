...
{
    public $table = 'themes';
    public $fillable = ['secret_id', 'name', 'slug', 'view_type', 'web_types', 'version', 'description','image', 'privacy', 'zip', 'available', 'deleted'];

    
    /**
     * @var array $jsonFields các cột dùng kiểu json
     */
    protected $jsonFields = ['components', 'options', 'areas', 'layout', 'menus'];
    ...
    {
        return $this->belongsTo('App\Models\User', 'id')->select('id','name', 'avatar', 'email');
    }
