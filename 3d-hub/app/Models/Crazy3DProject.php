...
class Crazy3DProject extends Model
{
    public $table = 'crazy_3d_projects';
    ...
    {
        return $this->hasMany(Crazy3DItemRef::class, 'ref_id', 'id')->where('ref', 'project');
    }
    ...
    {
        $path = 'static/sources/projects/' . $this->thumbnail;
        // dd($path);
    ...
    {
        if ($this->thumbnail && file_exists($p = public_path('static/sources/projects/' . $this->thumbnail))) {
            unlink($p);
        }
        # code...
    }
