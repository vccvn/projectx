...
class Register extends BaseValidator
{
    public function extends()
    {
        ...
        $this->addRule('edumail', function($attr, $value){
            return preg_match('/.*\.edu\.vn$/si', $value);
        });
    ...
    public function rules()
    {
        $rules = [
            ...
            'email'               => 'required|email|unique_attr|edumail',
            // 'phone_number'        => 'phone_number|phone_exists',
            // 'avatar'              => 'mimes:jpg,jpeg,png,gif',
            // 'username'            => 'username|unique_attr|min:4|max:64',
    ...
    public function messages()
    {
        return [
            ...
            'email.unique_attr'                    => 'Do vấn đề bảo mật, Bạn không thể sử dụng email này',
            'email.edumail'                        => 'Chỉ chấp nhận email có dạng xxxxxx@fpt.edu.vn',
            ...
            'agree.required'                       => 'Bạn phải đồng ý với các diều khoản để sử dụng dịch vụ'
