...
class AuthController extends ClientController
{
    ...
    public function postRegister(Request $request)
    {
        ...
        //     $response = $api->post('http://api.vcc.vn/auth/register', $request->all(), [
        ...
        //             'type' => 'success',
        //             'message' => 'Đăng ký thành công! Vui lòng truy cập hộp thư đến để xác minh email'
        //         ]);
        //     }
        //     // dd($response);
        //     return redirect()->route('client.account.register')->withInput($request->all())->withErrors($errors)->with('error', $message);

        // } catch (NotReportException $th) {
        //     //throw $th;
        //     // dd($th);
        //     return redirect()->route('client.account.register')->withInput($request->all())->withErrors($errors)->with('error', 'Lỗi không xác định');
        // }
    ...
    public function postLogin(Request $request)
    {
        ...
        return redirect()->route('client.account.login')->withInput($request->all())->with('error', $message);
    }
