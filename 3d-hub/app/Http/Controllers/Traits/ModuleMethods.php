...
trait ModuleMethods
{
    ...
    public function moduleInit()
    {
        ...
        if(!$this->moduleRoute) $this->moduleRoute = $this->module;
        if(!$this->moduleMenuKey) $this->moduleMenuKey = $this->module;
        if ($this->repository && $this->repository->checkField('deleted')) {
            $this->repository->addDefaultParam('deleted', 'deleted', 0);
        }
    ...
    {
        return $this->getRouteUrl($this->moduleRoute.'.'.$routeName, $params);
    }
