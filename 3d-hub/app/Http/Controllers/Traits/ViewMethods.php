 ...
 * @method void beforeGetIndexView(Request $request)
 * @method void beforeGetListData(Request $request)
 * @method void beforeGetListView(Request $request)
 * @method void beforeGetTrashData(Request $request) 
 * @method void beforeGetTrashView(Request $request)
 * @method void beforeGetDetailData(Request $request) 
 * @method void beforeGetDetailView(Request $request)
 * @method void beforeGetCreateForm(Request $request)
 * @method void beforeGetUpdateForm(Request $request)
 *
 * @method void beforeGetIndex(Request $request)
 * @method void beforeGetList(Request $request)
 * @method void beforeGetTrash(Request $request) 
 * @method void beforeGetDetail(Request $request) 
...
trait ViewMethods
{
    ...
    {
        $this->callViewEvent('beforeGetIndex', $request);
        if($this->flashMode){
    ...
    function getList(Request $request) {
        $this->callViewEvent('beforeGetList', $request);
    ...
    function getDetail(Request $request, $id = null) {
        $this->callViewEvent('beforeGetDetail', $request);
    ...
    function getTrash(Request $request) {
        $this->callViewEvent('beforeGetTrash', $request);
        
        $this->activeMenu($this->moduleMenuKey.'.trash');
        $this->repository->resetDefaultParams('deleted');
        $this->callViewEvent('beforeGetTrashData', $request);
        if($this->flashMode){
            return $this->getFlashModeListData($request, ['deleted' => 1], ['list_group' => 'trash']);
        }
    ...
    {
        $this->activeMenu($this->moduleMenuKey.'.create');
    ...
    public function getUpdateForm(Request $request, $id = null)
    {
        ...
        if($request->id && $detail = $this->repository->getFormData([$keyName=>$request->id])){
            ...
            $this->activeMenu($this->moduleMenuKey.'.update');
            $this->activeMenu($this->moduleMenuKey);
