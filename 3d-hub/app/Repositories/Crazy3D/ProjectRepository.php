...
class ProjectRepository extends BaseRepository
{
     ...
     */
    protected $validatorClass = 'Crazy3D\ProjectValidator';
     ...
     * @var string
     */
    protected $maskClass = 'Crazy3D\ProjectMask';
     ...
     * @var string
     */
    protected $maskCollectionClass = 'Crazy3D\ProjectCollection';
    ...
    {
        return \App\Models\Crazy3DProject::class;
    }
    ...
    /**
     * Cập nhật dữ liệu
     * @param Crazy3DProject|int $id
     * @param array $data
     * @return boolean
     */
    public function updateData($id, $data)
    {
        $project = is_object($id) && is_a($id, Crazy3DProject::class) ? $id: (($a = $this->findBy('id', $id))? $a : null);
        ...
        $a = $this->updateModelItemRefs($project->id, $objects);
        if(!$a) return false;
        $project->__data__ = $data;
        return $project->save();
    }
     ...
     * @return mixed
     */
    public function updateModelItemRefs(int $project_id, array $object_items = [])
    {
        ...
        $refs = $this->itemRefRepository->get(['ref'=>'project', 'ref_id' => $project_id]);
        ...
        foreach ($object_items as $key => $obj) {
            ...
            if(isset($needUpdate[$secret_key]) || array_key_exists($secret_key, $needUpdate))
                ...
                $a = $this->itemRefRepository->addItem($item_id, 'project', $project_id, $secret_key, $settings);
