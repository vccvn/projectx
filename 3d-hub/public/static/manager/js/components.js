$(function () {
    const Component = function (options) {
        ...
        this.showForm = function (data) {
            ...
            App.htmlSelect.deactive("component_id");
            App.htmlSelect.active("component_id", d.component_id);
            self.files = {};
            var inputFiles = $('#component-form').find('input[type="file"]');
            if (inputFiles.length) {
                inputFiles.attr("data-on-change", "App.components.onFileChange");
        ...
        this.save = function (data) {
            self.hide();
            if (!data.component_id) return App.Swal.error("component không hợp lệ", null, function () {
                self.show();
            });
        ...
        this.onStart = function () {
            ...
            $(document).on('click', '.btn-add-component', function (e) {
                ...
                App.Swal.show("component-select-modal");
            });
