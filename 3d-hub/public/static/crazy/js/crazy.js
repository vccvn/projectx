...
App.setup = function(object, data){
    if (!data || typeof data == 'undefined') return;
        for (var key of object.init_list) {
            if (typeof data[key] != 'undefined') {
                ...
                var t2 = (typeof(object[key]) != 'undefined') ? App.getType(object[key]) : "string";
...
App.getEl = function(obj,key,delimiter){
    ...
    var tpo = App.getType(obj);
    var tpk = App.getType(key);
    if(tpo=='array'){
        var k = NaN;
        if(tpk == 'number'){
            k = key;
...
App.html = {
    ...
    dom: function(tag, content, attributes){
        ...
        this.append = function(child){
            if(child.constructor == App.html.dom) {
        ...
        this.appendTo = function (parent) {
            if(parent.constructor == App.html.dom){
                this.parent = parent;
                parent.append(this);
