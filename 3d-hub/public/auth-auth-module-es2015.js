...
/*!*********************************************!*\
  ...
  \*********************************************/
/*! exports provided: COMPONENTS, AuthRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _core_guards__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_core/guards */ "IvES");
/* harmony import */ var _layout_layout_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./layout/layout.component */ "EQsV");
...
const COMPONENTS = [_login_login_component__WEBPACK_IMPORTED_MODULE_1__["LoginComponent"], _layout_layout_component__WEBPACK_IMPORTED_MODULE_3__["LayoutAuthComponent"]];
...
/*!*************************************!*\
  ...
  \*************************************/
/*! exports provided: AuthActionTypes, Login, LoginSuccess, LoginFailure, AuthEffects, initialState, reducer, selectAuthState, getIsAuthenticating */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _auth_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth.actions */ "/WaZ");
...
/* harmony import */ var _auth_effects__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth.effects */ "OW08");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AuthEffects", function() { return _auth_effects__WEBPACK_IMPORTED_MODULE_1__["AuthEffects"]; });

/* harmony import */ var _auth_reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth.reducer */ "qkvP");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "initialState", function() { return _auth_reducer__WEBPACK_IMPORTED_MODULE_2__["initialState"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "reducer", function() { return _auth_reducer__WEBPACK_IMPORTED_MODULE_2__["reducer"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "selectAuthState", function() { return _auth_reducer__WEBPACK_IMPORTED_MODULE_2__["selectAuthState"]; });

/* harmony import */ var _auth_selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth.selectors */ "Xd88");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getIsAuthenticating", function() { return _auth_selectors__WEBPACK_IMPORTED_MODULE_3__["getIsAuthenticating"]; });
...
/***/ "EQsV":
/*!*************************************************!*\
  !*** ./src/app/auth/layout/layout.component.ts ***!
  \*************************************************/
...
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services */ "bTys");
/* harmony import */ var _app_core_services_setting_setting_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @app/_core/services/setting/setting.service */ "uEm4");
...
const { AuthActionTypes } = _auth_actions__WEBPACK_IMPORTED_MODULE_3__;
class AuthEffects {
    constructor(actions$, authenticationService, settingService, router) {
        this.actions$ = actions$;
        this.authenticationService = authenticationService;
        this.settingService = settingService;
        this.router = router;
        this.login$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["ofType"])(AuthActionTypes.LOGIN), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((action) => action.payload), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])((payload) => {
            return this.authenticationService.login(payload.email, payload.password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((user) => new _auth_actions__WEBPACK_IMPORTED_MODULE_3__["LoginSuccess"](user)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])((error) => {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(new _auth_actions__WEBPACK_IMPORTED_MODULE_3__["LoginFailure"]({ error }));
            }));
        }));
        this.loginSuccess$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["ofType"])(AuthActionTypes.LOGIN_SUCCESS), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((res) => {
            this.settingService.setUser(res.payload);
            this.router.navigate(['p/teams']);
        }));
    }
}
AuthEffects.ɵfac = function AuthEffects_Factory(t) { return new (t || AuthEffects)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["Actions"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_services__WEBPACK_IMPORTED_MODULE_6__["AuthenticationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_app_core_services_setting_setting_service__WEBPACK_IMPORTED_MODULE_7__["SettingService"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"])); };
...
/*!**********************************************!*\
  ...
  \**********************************************/
/*! exports provided: getIsAuthenticating */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getIsAuthenticating", function() { return getIsAuthenticating; });
/* harmony import */ var _auth_reducer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth.reducer */ "qkvP");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "l7P3");


const getIsAuthenticating = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_auth_reducer__WEBPACK_IMPORTED_MODULE_0__["selectAuthState"], (state) => state.isAuthenticating);
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./store */ "DvZs");
...
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../_shared/shared.module */ "i2L+");
/* harmony import */ var _app_ui_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../app-ui.module */ "iasb");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./login/login.component */ "bsvf");
/* harmony import */ var _layout_layout_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./layout/layout.component */ "EQsV");
...
AuthModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineInjector"]({ providers: [], imports: [[
            _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"],
            _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
            _auth_routing_module__WEBPACK_IMPORTED_MODULE_1__["AuthRoutingModule"],
            _shared_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"],
            _app_ui_module__WEBPACK_IMPORTED_MODULE_8__["AppUIModule"],
            _ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["EffectsModule"].forFeature([_store__WEBPACK_IMPORTED_MODULE_4__["AuthEffects"]]),
            _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["StoreModule"].forFeature('authStore', _store__WEBPACK_IMPORTED_MODULE_4__["reducer"]),
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵsetNgModuleScope"](AuthModule, { declarations: [_auth_component__WEBPACK_IMPORTED_MODULE_5__["AuthComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_10__["LoginComponent"], _layout_layout_component__WEBPACK_IMPORTED_MODULE_11__["LayoutAuthComponent"]], imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"],
        _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
        _auth_routing_module__WEBPACK_IMPORTED_MODULE_1__["AuthRoutingModule"],
        _shared_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"],
        _app_ui_module__WEBPACK_IMPORTED_MODULE_8__["AppUIModule"], _ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["EffectsFeatureModule"], _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["StoreFeatureModule"]] }); })();
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../store */ "DvZs");
...
function LoginComponent_nz_alert_7_Template(rf, ctx) { if (rf & 1) {
...
/*!********************************************!*\
  ...
  \********************************************/
/*! exports provided: initialState, reducer, selectAuthState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _auth_actions__WEBPACK_IMPORTED_MODULE_0__["AuthActionTypes"].LOGIN:
            return Object.assign(Object.assign({}, state), { isAuthenticating: true, errorMessage: null, isAuthenticated: false });
        case _auth_actions__WEBPACK_IMPORTED_MODULE_0__["AuthActionTypes"].LOGIN_SUCCESS:
            return Object.assign(Object.assign({}, state), { errorMessage: null, isAuthenticated: true, isAuthenticating: false, user: {
        ...
        case _auth_actions__WEBPACK_IMPORTED_MODULE_0__["AuthActionTypes"].LOGIN_FAILURE:
            return Object.assign(Object.assign({}, state), { errorMessage: action.payload.error, isAuthenticating: false });
        default:
            return state;
    }
}
const selectAuthState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createFeatureSelector"])('authStore');
