...
trait InputTypes{
    ...
    protected static $inputTemplates = [
        ...
        'deepselect', 'crazyselect', 'crazytag', 'multiselect', 'select2', 'cropit', 'crazyprop', 
        'tinymce','gallery', 'attribute','product', 'variant-attribute', 'colorpicker', 'area',
        'dateselect',
        'inputgroup',
        'modelpreview', '3dpreview'
    ...
    protected $crazyInputMethods = [
        ...
        'modelpreview'           => 'prepareModelPreview',
        '3dpreview'              => 'prepare3DPreview',
    ];
    ...
    public function prepareModelPreview()
    {
        $this->template = 'modelpreview';
        // dd("jh");
        $this->data('id', $this->id);
        
    }
    public function prepare3DPreview()
    {
        $this->template = '3dpreview';
        // dd("jh");
        $this->data('id', $this->id);
