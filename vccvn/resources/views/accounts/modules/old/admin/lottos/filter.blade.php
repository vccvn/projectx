            ...
            <form action="" method="get" class="filter-form">
                <div class="form-group row mb-0">
                    ...
                    <div class="col-8 col-sm-6 col-md-3 ">
                        <div class="input-group">
                            <input type="text" name="open_date" id="date-range" class="form-control date-picker" placeholder="Ngày mở thưởng" data-format="yy-mm-dd" value="{{$date}}" autocomplete="off">
                    ...
                    <div class="col-4 col-sm-6 col-md-1">
                        <div class="input-group">
                            <button type="submit" class="btn btn-primary btn-block">
                                <span class="d-none d-sm-inline text-white"><i class="fa fa-filter"></i></span> <span class="d-md-none text-white">Lọc</span> </button>
                        </div>
                    </div>
                </div>
            </form>
