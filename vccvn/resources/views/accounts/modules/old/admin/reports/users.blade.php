...
@section('js')
    ...
    window.smarttableInit = function(){
        ...
        var $list = App.smarttable.setup({
            ...
            // filterForm: '.filter-form',
            urls: {!! json_encode([
                'data'           => route('admin.reports.users.list')
            ]) !!},
            pagination: {
                per_page: 10,
                size: 5
            ...
            columns: [
                ...
                {
                    title: "ID",
                    className: "id-col max-70 text-center",
                    sortby: 'ID',
                    content: '{$id}'
                },
            ...
            numberFormat: ['number_count', 'total_point', 'win_count', 'win_points'],
            handle:{
                prepare: function(){
        ...
        var $detail = App.smarttable.setup({
            ...
            // filterForm: '.filter-form',
            urls: {!! json_encode([
                'data'           => route('admin.reports.users.detail')
            ]) !!},
            autoload:false,
            columns: [
                {
            ...
            parseItem: function (betting) {
                ...
                // console.log(betting);
                // console.log(betting.recived_points);
        ...
        var url = "{{route("admin.reports.users.detail")}}";
