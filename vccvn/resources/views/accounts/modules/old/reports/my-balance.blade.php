...
@section('title', 'Báo cáo Doanh thu Cá nhân')
@section('header_title', 'Báo cáo Doanh thu Cá nhân')
...
@section('js')
    ...
    window.smarttableInit = function(){
        ...
        var $list = App.smarttable.setup({
            ...
            // filterForm: '.filter-form',
            urls: {!! json_encode([
                'data'           => route('reports.my.balance.data'),
                'download'       => route('reports.my.balance.download'),
            ...
            numberFormat: ['total', 'point_out', 'point_in', 'user_count'],
            handle:{
                prepare: function(){
