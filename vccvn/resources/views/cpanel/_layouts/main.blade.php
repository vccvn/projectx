...
<html lang="vi">
	...
	@endphp
	<body class="m-page--fluid m--skin- m-content--skin-light2 {{$hf}} m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default  @yield('body.class') ">
		<!-- begin:: Page -->
