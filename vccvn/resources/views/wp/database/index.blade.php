						...
						<div class="form-group m-form__group row {{$errors->has('db_name')?'has-danger':''}}">
							...
							<div class="col-lg-9">
								...
								<div class="input-group m-input-group m-input-group--air">
									...
									<input type="text" name="db_name" value="{{$user->secret_key}}_db" id="db_name" class="form-control m-input" placeholder="Tên CSDL" aria-describedby="db_name_label" readonly disabled>
						...
						<div class="form-group m-form__group row {{$errors->has('db_username')?'has-danger':''}}">
							...
							<div class="col-lg-9">
								...
								<div class="input-group m-input-group m-input-group--air">
									...
									<input type="text" name="db_username" value="{{$user->secret_key}}_master" id="db_username" class="form-control m-input" placeholder="Tên người dùng" aria-describedby="db_username_label" readonly disabled>
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-9">
								...
								<div class="input-group m-input-group m-input-group--air">
									...
									<input type="text" name="db_name" value="{{$user->secret_key}}_db" id="db_name" class="form-control m-input" placeholder="Tên CSDL" aria-describedby="db_name_label" readonly>
								</div>
						...
						<div class="form-group m-form__group row ">
							...
							<div class="col-lg-9">
								...
								<div class="input-group m-input-group m-input-group--air">
									...
									<input type="text" name="db_username" value="{{$user->secret_key}}_master" id="db_username" class="form-control m-input" placeholder="Tên người dùng" aria-describedby="db_username_label" readonly>
