						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									@if ( is_array($map = admin_breadcrumbs()) )
									@foreach ($map as $item)
							...
							@if ($actionmenus = admin_action_menu())
											...
											<div class="m-dropdown__body">
												<div class="m-dropdown__content">
													<ul class="m-nav">
														...
														<li class="m-nav__item">
															<a href="{{$a->url?$a->url:($a->link?$a->link:($a->route?route($a->route, $a->params?$a->params:[]):'javascript:void(0);' ))}}" class="m-nav__link {{$a->class}}">
																@if ($a->icon)
