		...
		<!--end::Base Styles -->
        <link rel="shortcut icon" href="{{asset('static/manager/assets/demo/default/media/img/logo/favicon.ico')}}" />
		...
		<link rel="stylesheet" href="{{asset('static/manager/css/branch.min.css')}}" type="text/css">
