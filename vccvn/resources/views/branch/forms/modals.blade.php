<?php
add_js_src('manager/js/dropzone.gallery.js');
add_css_link('manager/css/dropzone.gallery.min.css');
?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <a href="javascript:void(0);" class="btn btn-default text-info btn-toggle-dropzone-gallery">
                        <span class="fa fa-cloud-upload-alt text-info"></span> Tải lên 
                    </a>
                </div>
