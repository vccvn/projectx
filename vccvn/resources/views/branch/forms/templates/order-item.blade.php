...
<div class="order-item order-product-item row {{$hasError?'has-danger':''}}" id="order-item-{{$index}}">
    ...
    <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
        ...
        <div class="buttons">
            <a href="javascript:void(0);" data-index="{{$index}}" data-toggle="m-tooltip" data-placement="left" data-original-title="Xóa san phẩm" class="btn-delete-order-product-item text-danger btn btn-outline-danger btn-sm m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air">
