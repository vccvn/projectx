                                                ...
                                                <div class="col-12 col-sm-10 col-md-11">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 col-sm-7 col-md-8">
                                                            <input type="text" name="{{$name.'[prop_list]['.$loop->index.'][value]'}}" class="form-control m-input" value="{{$propItem->value}}" placeholder="value">
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="row prop-list-item mt-3" id="{$name}-{$index}-prop-list-{$loop_index}">
            <div class="col-12 col-sm-10 col-md-11">
                <div class="row">
                    ...
                    <div class="col-6 col-sm-7 col-md-8">
                        <input type="text" name="{$name}[{$index}][prop_list][{$loop_index}][value]" class="form-control m-input" placeholder="value">
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-2 col-md-1">
