...
<div {!! $wrapper->attrsToStr() !!}>
    ...
    <div class="gallery-hidden-input-group d-none">
        @if (count($gallery))
            @foreach ($gallery as $file)
                <input type="hidden" name="{{$baseName.'[]'}}" value="{{$file->id}}" id="hidden-input-gallery-image-{{$file->id}}">
            @endforeach
        @endif
    </div>
    ...
    <div class="gallery-images">
        @if (count($gallery))
            @foreach ($gallery as $file)
                ...
                <div class="dz-preview dz-image-preview" id="input-gallery-image-{{$file->id}}">
                    <div class="dz-image">
                        <img data-dz-thumbnail="" alt="{{$file->filename}}" src="{{$file->getThumbnail()}}">
                    </div>
        ...
        <div class="dz-preview dz-image-preview button-add" id="input-gallery-add-button">
            <div class="dz-image">
                <img data-dz-thumbnail="" alt="Thêm ảnh" src="{{asset('static/manager/assets/images/plus-icon.png')}}">
            </div>
            <div class="dz-details">
