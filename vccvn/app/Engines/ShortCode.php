...
class ShortCode
{
    ...
    function doShortCode($content, $ignore_html = false)
    {
        ...
        $content = preg_replace_callback("/$pattern/", 'App\Engines\do_shortcode_tag', $content);
        ...
        foreach ($textarr as &$element) {
            ...
            if (false === $attributes) {
                ...
                if (1 === preg_match('%^<\s*\[\[?[^\[\]]+\]%', $element)) {
                    $element = preg_replace_callback("/$pattern/", 'App\Engines\do_shortcode_tag', $element);
                }
            ...
            foreach ($attributes as &$attr) {
				 ...
				 */
                    $attr = preg_replace_callback("/$pattern/", 'App\Engines\do_shortcode_tag', $attr);
                } else {
