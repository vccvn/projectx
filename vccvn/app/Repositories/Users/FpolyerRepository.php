...
class FpolyerRepository extends BaseUserRepository
{
     ...
     */
    protected $validatorClass = 'App\Validators\Users\FpolyerValidator';
    ...
    public function init(){
        $this->addDefaultParam('type', 'fpoly-student')->addDefaultValue('type', 'fpoly-student');
        $this->defaultSortBy = [
            'id' => 'DESC'
        ];
    }
