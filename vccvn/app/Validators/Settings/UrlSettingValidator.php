...
class UrlSettingValidator extends BaseValidator
{
    ...
    {
        if(count($items = $this->repository->getUrlOptionItems($this->route('group')))){
            $rules = [];
            $messages = [];
            foreach ($items as $item) {
                ...
                if(in_array('number', [$item->type, $item->value_type])){
                    ...
                    $rule[] = 'mimes:jpg,jpeg,png,gif,ico,svg,doc,docx,pdf';
