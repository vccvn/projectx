...
function network_step1( $errors = false ) {
	...
	if ( WP_CONTENT_DIR !== ABSPATH . WP_USER_CONTENT && ( allow_subdirectory_install() || ! allow_subdomain_install() ) ) {
...
';
		...
		echo '</p>';
		if ( ! $subdomain_install && WP_CONTENT_DIR !== ABSPATH . WP_USER_CONTENT ) {
