...
function wp_check_php_mysql_versions() {
	...
	if ( ! extension_loaded( 'mysql' ) && ! extension_loaded( 'mysqli' ) && ! extension_loaded( 'mysqlnd' )
		...
		&& ( defined( 'WP_CONTENT_DIR' ) && ! file_exists( WP_CONTENT_DIR . '/db.php' )
			|| ! file_exists( ABSPATH . WP_USER_CONTENT . '/db.php' ) )
	) {
	...
	if ( ! defined( 'WP_LANG_DIR' ) ) {
		if ( file_exists( WP_CONTENT_DIR . '/languages' ) && @is_dir( WP_CONTENT_DIR . '/languages' ) || ! @is_dir( ABSPATH . WPINC . '/languages' ) ) {
			...
			if ( ! defined( 'LANGDIR' ) ) {
				...
				define( 'LANGDIR', WP_USER_CONTENT . '/languages' );
			}
		} else {
			/**
			 * Server path of the language directory.
...
function wp_load_translations_early() {
	...
	while ( true ) {
		...
		if ( @is_dir( ABSPATH . WP_USER_CONTENT . '/languages' ) ) {
			$locations[] = ABSPATH . WP_USER_CONTENT . '/languages';
		}
