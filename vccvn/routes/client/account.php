...
Route::middleware('client.auth')->group(function () {
     ...
     * -------------------------------------------------------------------------------------------------------------------------------
     */
    Route::get('tai-khoan.html',                  $controller.'index'                 )->name($r);
    $r.='.';
    Route::prefix('tai-khoan')->group(function() use($controller, $r){
        Route::get('cap-nhat/{tab}.html',         $controller.'index'                 )->name($r.'settings');
        Route::post('cap-nhat/{tab}.html',        $controller.'updateAccount'         );
        Route::post('cap-nhat/{tab}',             $controller.'updateAccount'         )->name($r.'settings.save');
    });    
});
