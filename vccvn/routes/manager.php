...
Route::prefix('install')->middleware(['install.denied'])->group(function () {
    $controller = 'InstallController@';
    $route = 'install.';
    Route::get('/',                               $controller . 'installForm'    )->name($route.'form');
    Route::post('/create'             ,           $controller . 'createInstall'  )->name($route.'create');
});

Route::middleware(['install.check', 'manager'/*, '2fa'*/])->group(function () {
